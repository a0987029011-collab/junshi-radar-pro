...
- 深層掃描會從結構低點建立進場區與停損，再以上方高檔吞噬 K 或雙層前高形成獲利區；只有仍靠近進場區且區間風險報酬充足的股票會進入「深層獲利區」清單。
- 月線長週期掃描會固定尚未被紅 K 實體穿越的大級別下降線，分開追蹤較短的跟隨線；MACD 縮柱且關鍵低點仍由月收盤守住時，列入「月線長週期」觀察，再下鑽週線與日線找機會。
